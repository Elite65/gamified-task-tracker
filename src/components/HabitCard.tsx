    ...
    return (
        <div className="bg-tech-surface border border-tech-border rounded-2xl p-4 flex flex-col gap-4 relative overflow-hidden group">
            ...
            <div className="absolute bottom-0 left-0 h-1 bg-tech-surface-hover w-full">
                <div
                    className={`h-full transition-all duration-500 ${isCompleted ? 'bg-yellow-400 shadow-[0_0_10px_rgba(250,204,21,0.5)]' : 'bg-tech-primary'}`}
            ...
            <div className="flex items-end justify-between z-10">
                <div>
                    <div className="flex items-baseline gap-1">
                        <span className={`text-2xl font-bold font-mono ${isCompleted ? 'text-yellow-400' : 'text-tech-primary'}`}>
                            {currentAmount}
                        </span>
