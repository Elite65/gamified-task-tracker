...
export const themes: Theme[] = [
    ...
    },
    {
        ...
        colors: {
            // Dynamic Background: Original Snowflakes (Scattered Randomly 500px) + Dark Winter Night Gradient
            background: "url(\"data:image/svg+xml;utf8,<svg width='500' height='500' viewBox='0 0 500 500' xmlns='http://www.w3.org/2000/svg'><defs><g id='crystal'><g id='arm'><path d='M0,0 L0,-18' stroke='%23bae6fd' stroke-width='1.5' stroke-linecap='round'/><path d='M0,-5 L3,-8 M0,-5 L-3,-8' stroke='%23bae6fd' stroke-width='1.2' stroke-linecap='round'/><path d='M0,-10 L5,-15 M0,-10 L-5,-15' stroke='%23bae6fd' stroke-width='1.2' stroke-linecap='round'/><circle cx='0' cy='-18' r='1' fill='%23bae6fd'/></g><use href='%23arm'/><use href='%23arm' transform='rotate(60)'/><use href='%23arm' transform='rotate(120)'/><use href='%23arm' transform='rotate(180)'/><use href='%23arm' transform='rotate(240)'/><use href='%23arm' transform='rotate(300)'/></g><g id='star'><path d='M0,-8 L0,8 M-7,-4 L7,4 M-7,4 L7,-4' stroke='%23bae6fd' stroke-width='1.5' stroke-linecap='round'/><circle cx='0' cy='0' r='1.5' fill='%23bae6fd'/></g></defs><g opacity='0.2'><!-- Random Scatter --><use href='%23crystal' x='50' y='50' transform='scale(0.8) rotate(15)'/><use href='%23star' x='150' y='100' transform='scale(1.2)'/><use href='%23crystal' x='300' y='80' transform='scale(0.6) rotate(-10)'/><use href='%23crystal' x='450' y='150' transform='scale(1.0) rotate(45)'/><use href='%23star' x='80' y='250' transform='scale(0.9)'/><use href='%23crystal' x='250' y='250' transform='scale(1.3) rotate(30)'/><use href='%23star' x='400' y='350' transform='scale(1.1)'/><use href='%23crystal' x='100' y='400' transform='scale(0.7) rotate(-20)'/><use href='%23star' x='250' y='450' transform='scale(1.0)'/><use href='%23crystal' x='450' y='450' transform='scale(0.9) rotate(60)'/><!-- Filler Stars --><use href='%23star' x='200' y='30' transform='scale(0.5)'/><use href='%23star' x='350' y='200' transform='scale(0.6)'/><use href='%23star' x='30' y='350' transform='scale(0.5)'/></g></svg>\") repeat, linear-gradient(180deg, #1e293b 0%, #334155 100%)",
